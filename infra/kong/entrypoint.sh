...
envsubst '$AUTH_SERVICE_URL $COMPOSITE_APPOINTMENT_URL $COMPOSITE_PATIENT_URL $QUEUE_COORDINATOR_URL $ACTIVITY_LOG_SERVICE_URL $PATIENT_SERVICE_URL $BETTER_AUTH_RSA_PUBLIC_KEY_ESCAPED' \
