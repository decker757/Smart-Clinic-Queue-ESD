...
envsubst '$AUTH_SERVICE_URL $COMPOSITE_APPOINTMENT_URL $COMPOSITE_CONSULTATION_URL $COMPOSITE_PATIENT_URL $COMPOSITE_STAFF_URL $QUEUE_COORDINATOR_URL $ACTIVITY_LOG_SERVICE_URL $PATIENT_SERVICE_URL $DOCTOR_SERVICE_URL $CHECKIN_ORCHESTRATOR_URL $BETTER_AUTH_RSA_PUBLIC_KEY_ESCAPED' \
